    ...
    render () {
        ...
        for (var i = 0; i < _textsLength; i++) {
            ...
            var _tmptext        = (tmpText.text) ? tmpText.text : _default_text,
                ...
                _tmpOffsetX     = (tmpText.offsetX || tmpText.offsetX === 0) ? Util.getPxNumber(tmpText.offsetX) : _default_offsetX,
                _tmpOffsetY     = (tmpText.offsetY || tmpText.offsetY === 0) ? Util.getPxNumber(tmpText.offsetY) : _default_offsetX,
